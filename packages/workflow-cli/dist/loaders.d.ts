 ...
 */
export declare function loadWorkflow(filePath: string): Promise<WorkflowDefinition>;
/**
 ...
 */
export declare function loadTasks(filePath: string): Promise<TaskDefinition[]>;
/**
 ...
 */
export declare function loadTasksFromDirectory(dirPath: string, options?: LoadTasksOptions): Promise<TaskDefinition[]>;
