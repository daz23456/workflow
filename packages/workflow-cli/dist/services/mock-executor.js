...
export class MockExecutor {
     ...
     */
    registerMockResponse(taskRef, response) {
    ...
    async execute(workflow, _tasks, input) {
        ...
        for (const group of groups) {
            ...
            for (const taskId of group) {
                ...
                const resolvedInput = this.resolveTemplates(taskDef.input || {}, context);
                // Get mock response
