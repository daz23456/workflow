...
import type { TaskSummary, GeneratedWorkflow, WorkflowPattern } from '../types/index.js';
...
4. Return valid YAML wrapped in \`\`\`yaml code blocks`
   ...
   */
  private parseResponse(responseText: string, intent: string): GeneratedWorkflow {
   ...
   */
  private detectPattern(yaml: string): WorkflowPattern {
