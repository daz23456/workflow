...
function WorkflowGraphViewer() {
    ...
    if (error) {
        return (react_1.default.createElement("div", { style: { padding: '20px', color: '#dc2626', fontFamily: 'sans-serif' } },
    ...
    if (!graph || graph.nodes.length === 0) {
        return (react_1.default.createElement("div", { style: {
            ...
            react_1.default.createElement("div", { style: { textAlign: 'center' } },
                react_1.default.createElement("svg", { style: { margin: '0 auto', height: '48px', width: '48px', color: '#9ca3af' }, fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
                ...
                react_1.default.createElement("p", { style: { marginTop: '8px', fontSize: '14px' } }, "No tasks in this workflow"))));
    }
    return (react_1.default.createElement("div", { style: { width: '100vw', height: '100vh' } },
        react_1.default.createElement(react_2.ReactFlow, { nodes: nodes, edges: edges, fitView: true, minZoom: 0.1, maxZoom: 2, defaultViewport: { x: 0, y: 0, zoom: 1 }, proOptions: { hideAttribution: true } },
            react_1.default.createElement(react_2.Controls, null),
            react_1.default.createElement(react_2.Background, { variant: react_2.BackgroundVariant.Dots, gap: 12, size: 1 }))));
}
