...
./scripts/complete-stage.sh --stage 17.1 --name "Test API Server"

# Check stage status
cat stage-proofs/stage-17.1/.stage-state.yaml
```
...
### BEFORE (do first)
- [x] Directory created: `stage-proofs/stage-17.1/`
- [x] Proof file created: `stage-proofs/stage-17.1/STAGE_17.1_PROOF.md`
- [x] State file created: `stage-proofs/stage-17.1/.stage-state.yaml`
...
### AFTER (completion)
- [ ] Run: `./scripts/run-quality-gates.sh --stage 17.1 1 2 3 4 5 6 7 8`
- [ ] All gates pass
- [ ] Run: `./scripts/complete-stage.sh --stage 17.1 --name "Test API Server"`
- [ ] Verify tag created: `git tag -l | grep stage-17.1`
...
- **Proof:** [`stage-proofs/stage-17.1/STAGE_17.1_PROOF.md`](./stage-proofs/stage-17.1/STAGE_17.1_PROOF.md)
